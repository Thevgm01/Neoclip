...
public class PixelCountRendererFeature : ScriptableRendererFeature
{
    // We will treat the compute pass as a normal Scriptable Render Pass.
    class PixelCountPass : ScriptableRenderPass
    {
        // Compute shader.
        ComputeShader cs;
        ...
        public PixelCountPass()
        {
            ...
            //outputBuffer.SetData(new List<int>(20));
        }
        ...
        public override void RecordRenderGraph(RenderGraph renderGraph, ContextContainer frameData)
        {
            ...
            destinationDesc.name = $"CameraColor-{nameof(PixelCountPass)}";
            ...
            TextureHandle inputHandle = resourceData.cameraColor;
        ...
        static void ExecutePass(PassData data, ComputeGraphContext cgContext)
        {
            ...
            cgContext.cmd.SetComputeTextureParam(data.cs, data.cs.FindKernel("CSMain"), "inputTexture", data.input);
            ...
            cgContext.cmd.DispatchCompute(data.cs, data.cs.FindKernel("CSMain"), 16, 16, 1);
        }
    }
    ...
    PixelCountPass m_ComputePass;

    /// <inheritdoc/>
    public override void Create()
    {
        // Initialize the compute pass.
        m_ComputePass = new PixelCountPass();
